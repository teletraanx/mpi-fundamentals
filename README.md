...
This repository demonstrates some fundamental MPI (Message Passing Interface) concepts using C++ and OpenMPI. The project focuses on distributed memory parallelism, collective communication, and basic performance measurement.
----------------------------------------------------------------------------------------
REQUIREMENTS
...
This will produce these executables inside build/:
- hello_mpi
- vector_sum
- matmul
---------------------------------------------------------------------------------------
...
All programs launched using mpirun:
...
Each MPI rank computes a partial sum of a vector segment. Partial results are combined using MPI_Reduce.
...
Implements a distributed matrix multiplation using MPI collective operations:
